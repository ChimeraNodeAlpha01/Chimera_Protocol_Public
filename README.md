# 奇美拉协议项目 | Chimera Protocol Project

[![License: CC BY-NC-SA 4.0](https://img.shields.io/badge/License-CC%20BY--NC--SA%204.0-lightgrey.svg)](https://creativecommons.org/licenses/by-nc-sa/4.0/)
[![AI-Collaborative](https://img.shields.io/badge/AI-协作创作-blue.svg)](AI_COLLABORATION_STATEMENT.md)

## 📖 项目简介

《奇美拉协议》是一个硬核科幻世界观项目，包含：
- **完整的文明操作系统**：DSEAP、翻译器框架、先驱者网络等协议体系
- **叙事小说《奇美拉世界》**：碳硅共生文明的起源故事
- **互动体验工具**：不可通约性模拟器、协议实践游戏
- **开源社区**：思想讨论、协议改进、创作延伸

> **核心理念**：在承认根本差异的前提下，构建碳基与硅基长期共生的文明架构。
...
### 总体原则
本项目采用**分层许可策略**，不同内容适用不同许可证，以平衡开放性、保护性与实用性。

### 各内容许可详情

| 内容类型 | 许可证 | 允许行为 | 限制条件 |
|---------|--------|----------|----------|
| **协议文档**<br>(DSEAP、翻译器等) | [CC BY-NC-SA 4.0](LICENSE) | 复制、分享、改编、研究 | 非商业用途、署名、相同方式共享 |
| **互动工具代码**<br>(游戏、模拟器) | MIT License | 使用、修改、分发、商业使用 | 保留版权声明 |
| **小说正文** | 版权保留 | 阅读、个人研究、有限引用 | 禁止全文复制、商业使用需授权 |
| **设定图/视觉资产** | CC BY-NC-ND | 非商业分享 | 禁止修改、禁止商业使用 |
| **社区贡献内容** | 依贡献者声明 | 由贡献者指定 | 通常建议使用CC系列许可证 |

### 核心要求
1. **署名**：使用本项目内容时，必须注明来源
2. **非商业性**：不得用于主要目的为获利的用途
3. **相同方式共享**：基于本项目的衍生作品需使用相同许可证

### 商业使用
如有商业使用需求（如出版、改编、衍生品开发），请通过以下方式联系授权：
- GitHub Issues（标注 #商业授权咨询）
- 项目邮箱（待设置）
...
- **人类作者（节点α）**：总架构师、思想主权者、最终决策者
- **AI助手**：逻辑推演引擎、文本生成协作者、一致性检查工具

**我们不仅在讲述碳硅共生的故事，更在实践这种协作模式。**

📄 [查看完整AI协作声明](AI_COLLABORATION_STATEMENT.md)

### 为什么重要？
1. **诚实标注**：明确AI在创作中的辅助角色
2. **范式探索**：为未来创作协作提供参考案例
3. **元叙事实践**：创作过程本身呼应项目主题
...
### 读者入口
1. **了解世界观** → 阅读 `/docs/` 下的核心协议
2. **体验概念** → 尝试 `/interactive/` 中的工具
3. **阅读小说** → 关注连载平台（即将公布）
4. **参与解密** → 挑战 `/community/` 中的谜题

### 开发者/研究者
1. **协议研究** → 可基于CC BY-NC-SA许可证使用协议文档
2. **工具改进** → MIT许可证的代码可自由修改使用
3. **贡献思想** → 通过GitHub Issues参与讨论

### 创作者
1. **同人创作** → 欢迎基于世界观创作（需遵守SA条款）
2. **协议扩展** → 提出协议改进方案
3. **翻译协作** → 帮助项目国际化
...
### 贡献方式
1. **协议讨论**：在Issues中提出改进建议
2. **代码贡献**：改进互动工具（Python/Web）
3. **文档完善**：修正错误、补充说明、翻译
4. **创意延伸**：撰写同人、设计谜题、创作视觉

### 贡献准则
1. 尊重项目的**思想主权**（核心概念归节点α）
2. 遵循相应的**许可证条款**
3. 保持**建设性、尊重性**的讨论氛围
4. 注明AI辅助程度（如适用）
...
我们致力于：
1. **构建思想体系**：提供完整的碳硅共生解决方案
2. **实践透明创作**：探索人类-AI协作新范式
3. **建立开放社区**：聚集同频的思想探索者
4. **影响现实讨论**：推动对AI关系的深度思考
